	...
	<div>
		<ContainerWrapper class="py-5">
			<div class="text-center mb-10">
				<h1 class="text-4xl font-bold mb-4 text-primary-blue">
					Media Center
				</h1>
				<p class="text-lg text-gray-700 max-w-2xl mx-auto">
					Experience inspiring messages through audio and video. Watch
					or listen to recent sermons, teachings, and special events.
					Let these resources encourage your faith and deepen your
					walk with God.
				</p>
			</div>
			<div class="bg-grey rounded-lg p-8">
				...
				>
					...
					<!-- Tabs -->
					<div
						class="flex justify-center space-x-4 border-b border-gray-300 w-full md:w-1/2 lg:w-1/3"
					>
						<div
							:class="[
					...
					<div v-else>
						...
						>
							...
							>
								...
								<div class="p-4 flex flex-col gap-2">
									...
									<h5
										class="!font-semibold text-primary-blue"
									>
						...
						<div v-else>
							<div class="flex flex-col">
								<div
									class="flex font-semibold border-b pb-2 mb-2"
								>
								...
								>
									...
									<div class="w-7 flex justify-center">
										<a
											:href="
												audio.primary.message_audio_link
													?.url
											"
											target="_blank"
											rel="noopener"
...
const filteredItems = computed(() => {
	...
	if (tab.value === "video") {
		return getSortedFiltered(data.value?.data?.slices ?? []);
	} else {
